...
export const CHAT_LIST_CACHE_KEY = "cheetah-chat-chat-list-cache";
export const CHAT_MESSAGES_CACHE_KEY = "cheetah-chat-chat-messages-cache";
export const CHAT_MESSAGES_INDEX_KEY = "cheetah-chat-chat-messages-index";
...
export const CHANNEL_SEEN_CACHE_KEY = "cheetah-chat-channel-seen";
...
export const canUseLocalStorage = () => {
  ...
  try {
    const testKey = "__cheetah-chat_ls_test__";
