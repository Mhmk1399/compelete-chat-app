...
export function MobileSettingsPanel({
  ...
  const resolvedUserColor = userColor || "#00dafd";
        ...
        <div className="space-y-4 md:hidden">
          <div className="rounded-2xl border border-slate-300/80 bg-white/90 p-4 text-slate-700 dark:border-emerald-500/20 dark:bg-slate-950/60 dark:text-slate-200">
            <button
              ...
              className="group flex w-full items-center gap-3 rounded-xl border border-transparent px-1 py-1 text-left transition hover:border-emerald-300 hover:bg-emerald-50/50 hover:shadow-[0_0_16px_rgba(0,218,253,0.18)] dark:hover:border-emerald-500/30 dark:hover:bg-emerald-500/10"
            >
              <Avatar
                src={user.avatarUrl}
                alt={displayName}
      ...
      {settingsPanel === "profile" ? (
        <div className="md:hidden">
          ...
          <form className="space-y-4" onSubmit={handleProfileSave}>
            ...
            <button
              type="submit"
              className="w-full rounded-xl bg-emerald-500 px-3 py-2 text-xs font-semibold text-white shadow-lg shadow-emerald-500/30 transition hover:bg-emerald-400 hover:shadow-[0_0_20px_rgba(0,218,253,0.4)]"
            >
              Save profile
            </button>
            ...
            <label className="block">
              ...
              <div className="relative mt-2">
                ...
                <button
                  ...
                  className="absolute right-1 top-1/2 inline-flex h-8 w-8 -translate-y-1/2 items-center justify-center rounded-full border border-transparent bg-transparent text-emerald-700 transition hover:bg-emerald-100 hover:shadow-[0_0_18px_rgba(0,218,253,0.22)] dark:text-emerald-200 dark:hover:bg-emerald-500/10"
                  aria-label={
                    showCurrentPassword
