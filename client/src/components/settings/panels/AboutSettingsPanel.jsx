...
export function AboutSettingsPanel({
  ...
  const currentButtonStyle = (() => {
    if (checkState.status === "checking") {
      return {
        className:
          "cursor-wait border border-emerald-200 bg-white px-2.5 py-1 text-[11px] font-semibold text-emerald-700 hover:border-emerald-300 hover:bg-emerald-50 hover:shadow-[0_0_14px_rgba(0,218,253,0.2)] dark:border-emerald-500/30 dark:bg-slate-900 dark:text-emerald-200 dark:hover:bg-emerald-500/10",
        label: "Checking",
      ...
      >
        ...
        <div className="border-t border-emerald-100/80 pt-4 dark:border-emerald-500/20">
          ...
          <p className="mt-1 text-center text-[11px] text-slate-500 dark:text-slate-400">
            All rights reserved. Cheetah Chat is a free and open-source project,
