...
export default function AuthFormFields({
  ...
  return (
    <form
      className="mt-4 space-y-10 sm:mt-6 sm:space-y-4"
      onSubmit={onSubmit}
      onReset={(event) => {
