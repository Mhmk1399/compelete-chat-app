              ...
              {chatsSearchFocused ? (
                ...
                <div className="relative" ref={createMenuRef}>
                  <button
                    ...
                    className="inline-flex items-center justify-center rounded-full border border-emerald-200 bg-white/80 p-2 text-emerald-700 transition hover:border-emerald-300 hover:shadow-[0_0_16px_rgba(0,218,253,0.22)] dark:border-emerald-500/30 dark:bg-slate-950 dark:text-emerald-200"
                    aria-label="Create"
          ...
          <div className="mt-3">
            <label className="group relative block">
              ...
              <input
                ...
                className={`w-full rounded-2xl border border-emerald-200 bg-white py-2 pr-10 text-sm text-slate-700 outline-none transition hover:border-emerald-300 hover:shadow-[0_0_16px_rgba(0,218,253,0.18)] focus:border-emerald-400 focus:bg-white/80 focus:ring-2 focus:ring-emerald-300/60 dark:border-emerald-500/30 dark:bg-slate-900 dark:text-slate-100 dark:hover:border-emerald-500/50 dark:hover:shadow-[0_0_18px_rgba(0,218,253,0.12)] dark:focus:bg-slate-950 ${
                  chatsSearchFocused || hasSearchText
                    ? searchIsRtl
