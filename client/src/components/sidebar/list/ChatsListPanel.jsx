                  ...
                  <ContextMenuSurface
                    ...
                    className={`flex w-full items-center gap-3 rounded-2xl border px-3 py-3 text-left text-sm transition ${
                      isActive
                        ...
                        : "border-slate-300/80 bg-white/90 text-slate-700 hover:border-emerald-300 hover:shadow-[0_0_20px_rgba(0,218,253,0.18)] focus-visible:border-emerald-300 focus-visible:shadow-[0_0_20px_rgba(0,218,253,0.18)] focus-visible:outline-none dark:border-emerald-500/20 dark:bg-slate-950/60 dark:text-slate-200"
                    }`}
                  >
                    <Avatar
                  ...
                  >
                    {group.avatarUrl ? (
                      ...
                      <div
                        ...
                        style={getAvatarStyle(group.color || "#00dafd")}
                      >
                        {initials}
                      </div>
                    )}
                ...
                return (
                  ...
                  >
                    {channel.avatarUrl ? (
                      ...
                      <div
                        className={`flex h-9 w-9 items-center justify-center rounded-full text-xs ${hasPersian(initials) ? "font-fa" : ""}`}
                        style={getAvatarStyle(channel.color || "#00dafd")}
                      >
                        {initials}
                      </div>
                    )}
            ...
            <div
              className={`w-full min-h-[72px] rounded-2xl border px-3 py-3 text-left text-sm transition ${
                activeChatId === conv.id
                  ? "border-emerald-400 bg-emerald-100 text-emerald-900 dark:border-emerald-400/60 dark:bg-emerald-500/20 dark:text-emerald-100"
                  : "border-slate-300/80 bg-white/90 text-slate-700 hover:border-emerald-300 hover:shadow-[0_0_20px_rgba(0,218,253,0.18)] dark:border-emerald-500/20 dark:bg-slate-950/60 dark:text-slate-200"
              } ${editMode ? "animate-chat-wiggle-ios shadow-[0_0_0_1px_rgba(0,218,253,0.35),0_0_16px_rgba(0,218,253,0.22)]" : ""}`}
              style={wiggleStyle}
            >
