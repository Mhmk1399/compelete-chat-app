...
export default function ChatWindowPanel({
  ...
  const [hideInsecureTooltip, setHideInsecureTooltip] = useState(() => {
    ...
    return window.localStorage.getItem("cheetah-chat-insecure-dismissed") === "1";
  });
  const isLocalhost =
    typeof window !== "undefined" &&
  ...
  useEffect(() => {
    ...
    const dismissed =
      window.localStorage.getItem("cheetah-chat-insecure-dismissed") === "1";
  ...
  const chatScrollStyle = useMemo(
    () => ({
      backgroundImage: isDark
        ? "radial-gradient(circle at top right, rgba(0,218,253,0.22), transparent 48%), radial-gradient(circle at bottom left, rgba(0,218,253,0.20), transparent 44%)"
        : "radial-gradient(circle at top right, rgba(0,218,253,0.10), transparent 45%), radial-gradient(circle at bottom left, rgba(0,218,253,0.09), transparent 40%)",
              ...
              onClick={() => {
                if (typeof window !== "undefined") {
                  window.localStorage.setItem(
                    "cheetah-chat-insecure-dismissed",
                    "1",
                  );
                }
