...
export const MessageItem = memo(function MessageItem({
  ...
  const forwardedTarget = forwardedFromChatId
    ...
    : forwardedFromUserId
      ? {
          ...
          color: msg?.forwarded_from_color || "#00dafd",
        }
      : forwardedFromLabel
        ? { kind: "self" }
        : null;
  ...
  const senderColor = isDeletedAuthor ? "#94a3b8" : msg.color || "#00dafd";
